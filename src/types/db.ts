  ...
  public: {
    Tables: {
      ...
      ingredients: {
        Row: {
          active: boolean
          category: Database["public"]["Enums"]["ing_category"]
          color: string | null
          default_qty: number
          id: string
          is_base: boolean
          ...
          price_cents: number
          step: number
          unit: Database["public"]["Enums"]["ing_unit"]
        }
        Insert: {
          active?: boolean
          category?: Database["public"]["Enums"]["ing_category"]
      ...
      order_item_ingredients: {
        ...
        Relationships: [
          {
            foreignKeyName: "order_item_ingredients_ingredient_id_fkey"
      ...
      pizza_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "pizza_likes_pizza_id_fkey"
            columns: ["pizza_id"]
            isOneToOne: false
            referencedRelation: "pizzas"
            referencedColumns: ["id"]
      ...
      pizzas: {
        Row: {
          ...
          is_public: boolean
          name: string | null
          origin: Database["public"]["Enums"]["pizza_origin"]
        ...
        Relationships: [
          {
            foreignKeyName: "pizzas_base_id_fkey"
            columns: ["base_id"]
            isOneToOne: false
            referencedRelation: "pizza_bases"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Enums: {
      delivery_status:
        ...
        | "delivered"
        | "cancelled"
      ing_category: "Base" | "Quesos" | "Carnes" | "Verdes" | "Hongos" | "Otros"
      ing_unit: "unit" | "g"
      order_status:
        | "draft"
        | "placed"
      ...
      stock_reason:
        ...
        | "return"
        | "transfer"
      user_role: "customer" | "delivery" | "pizzero" | "admin"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
